...
--  ⠀⠀⠀⠑⠀⠀⠀⠈⡇⠀⠀⠀⠀⣠⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠇       Updated: 2026/05/05 14:17:52 by oezzaou
--  ⠀⠀⠀⠀⠀⠀⠀⠀⡇⠀⠀⢀⣾⣿⣿⠿⠟⠛⠋⠛⢿⣿⣿⠻⣿⣿⣿⣿⡿⠀
--  ⠀⠀⠀⠀⠀⠀⠀⢀⠇⠀⢠⣿⣟⣭⣤⣶⣦⣄⡀⠀⠀⠈⠻⠀⠘⣿⣿⣿⠇⠀
--  ⠀⠀⠀⠀⠀⠱⠤⠊⠀⢀⣿⡿⣿⣿⣿⣿⣿⣿⣿⠀⠀⠀⠀⠀⠀⠘⣿⠏⠀⠀                             𓆩♕𓆪
--  ⠀⠀⠀⠀⠀⡄⠀⠀⠀⠘⢧⡀⠀⠀⠸⣿⣿⣿⠟⠀⠀⠀⠀⠀⠀⠐⠋⠀⠀⠀                     𓄂 oussama ezzaou𓆃
...
return {
  {
    ...
    opts = {
      ...
      window = {
        border = "rounded",
        width = 28, -- width of the tree
      },
      -- Filesystem Configuration:
      filesystem = {
        filtered_items = {
          visible = true,          -- hidden files managments
          hide_dotfiles = false,   -- dotfiles configs
          hide_gitignored = false, -- gitignored files
          hide_by_name = {         -- hide specific files by names
            ".git",
          },
          -- never_show = { ".git" }, -- never show these items in the list
        },
      },
      ...
      default_component_configs = {
        indent = {
          indent_size = 2,
          padding = 0,            -- Adds padding to the left of the tree nodes
